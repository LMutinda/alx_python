...
# Define a route for "/hbnb" with the option strict_slashes=False
...
# Define a route for "/number_odd_or_even/<n>" with the option strict_slashes=False
...
def display_number_odd_or_even(n):
    ...
    Returns:
        str: Display an HTML page with H1 tag: "Number: n is even|odd" inside the tag BODY.
    """
    if isinstance(n, int):
